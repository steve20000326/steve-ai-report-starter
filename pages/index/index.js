...
Page({
  ...
  onAddChild() {
    wx.navigateTo({ url: '/pages/child-add/child-add' })
  },
  ...
  goCreate(id, name) {
    ...
    wx.navigateTo({ url: '/pages/create/create?childId=' + id })
  },

  onViewTimeline(e) {
    const { id, name } = e.currentTarget.dataset
    wx.navigateTo({
      url: '/pages/timeline/timeline?childId=' + id + '&name=' + encodeURIComponent(name)
    })
  }
})
